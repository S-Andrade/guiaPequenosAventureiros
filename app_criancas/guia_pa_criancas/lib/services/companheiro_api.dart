...
import 'package:app_criancas/notifier/companheiro_notifier.dart';
...
//GET COMPANHEIRO
getCompanheiro(String userEmail, CompanheiroNotifier companheiroNotifier) {
  CollectionReference companheiroRef =
  Firestore.instance.collection('companheiro');
  DocumentReference companheiroDocRef = companheiroRef.document(userEmail);
  companheiroDocRef.get().then((snapshot){
    Companheiro c = Companheiro.fromMap(snapshot.data);
    companheiroNotifier.currentCompanheiro = c;
  });
}
