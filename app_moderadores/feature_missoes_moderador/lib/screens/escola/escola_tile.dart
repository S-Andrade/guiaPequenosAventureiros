...
class EscolaTile extends StatelessWidget {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  EscolaDetails(escola: escolafinal)));
                    },
                    child: Card(
  ...
  Future<void> getEscola() async {
    DocumentReference documentReference =
        Firestore.instance.collection("escola").document(escola);
  ...
  Future<void> deleteEscola(BuildContext context) async {
    DocumentReference documentReference =
        Firestore.instance.collection("escola").document(escolafinal.id);
    await documentReference.delete();

    List escolas = aventura.escolas;
    escolas.remove(escolafinal.id);
    DatabaseService().updateAventuraData(
        aventura.id,
        aventura.historia,
        aventura.data,
        aventura.local,
    ...
    for (String id_turma in escolafinal.turmas) {
      ...
      final StorageReference firebaseStorageRef =
          FirebaseStorage.instance.ref().child(turma.file);
