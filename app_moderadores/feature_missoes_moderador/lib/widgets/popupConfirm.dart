...
class MyTemplateConfirmation extends BeautifulPopupTemplate {
  final BeautifulPopup options;
  MyTemplateConfirmation(this.options) : super(options);

  @override
  final illustrationKey = 'assets/images/confirmar.jpg';
  @override
