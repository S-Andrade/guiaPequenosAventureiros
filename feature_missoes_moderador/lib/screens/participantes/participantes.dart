...
class _ParticipantesScreenState extends State<ParticipantesScreen> {
  ...
  void initState() {
    ...
    getCurrentUser().then((userR)=>setState((){this.user=userR;}));
                 ...
                 backgroundColor: Colors.transparent,
                  body: Container(
                    ...
                    Column(children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 100, bottom: 70.0),
                        child: Row(
                        ...
                        children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image:
                                        AssetImage("assets/images/animated17.gif"),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                              Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.only(
                                        left: 20.0, bottom: 30, top: 0, right: 20),
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: Colors.white,
                                      ...
                                      child: BarChartSample2(results: mapaEscolas),
                                    ),
                                  ))
                        ],
                      ),
                              ...
                              Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: BarChartSample2(results: mapaTurmas),
                                    ),
                                  )),
                              Padding(
                                padding: const EdgeInsets.only(
                                      ...
                                      itemBuilder: (context, int index) {
                                        return Column(
                                          children: [
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  right: 230, top: 20, bottom: 20),
                                              child:
                                                  Text("Turma " + turmasList[index],
                                                      style: TextStyle(
                                                        fontSize: 20,
                                                        letterSpacing: 1,
                                                      )),
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: () {
                                                          Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                  builder: (_) => PerfilAlunoScreen(
                                                                      alunoId: alunosPorTurma[
                                                                              turmasList[
                                                                                  index]]
                                                                          [
                                                                          index1])));
