...
setState((){
  escolaNome=escola;
          ...
          if(value2[2].length==0) setState((){uploaded.add("https://cdn.dribbble.com/users/598368/screenshots/3890110/dribble_no_data.jpg");});
          else setState((){uploaded=value2[2];});
  ...
  Widget build(BuildContext context) {
      ...
      if (aluno.idadeAluno != 'idade') {
        if (resultsByCapitulo.length != 0) {
          ...
          if (respostasFinal.length != 0) {
            ...
            if(respostasFinal[0]=="null")setState(() {
                                ...
                                Padding(
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                            ...
                                            child: new ListView.separated(
                                              ...
                                              itemCount: respostasFinal.length,
                                              separatorBuilder:
                                                  (context, int index) {
                                                return Divider(
                                                    height: 20,
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        child:Center(
                                          child: Text("Ainda não foram feitos questonários..",style: TextStyle(
            color: Colors.black,
            fontWeight: FontWeight.w900,
        ...
        return Scaffold(
                  appBar: new AppBar(backgroundColor: Colors.indigoAccent,title: new Text('Perfil do aluno')),
                  body: Container(color: Colors.indigoAccent[50],child:Center(child: Text("Ainda não há dados para este aluno...\n Isto significa que ele ainda não fez uma única vez login",style: TextStyle(
            color: Colors.black,
            fontWeight: FontWeight.w900,
            fontFamily: 'Amatic SC',
            letterSpacing: 2,
    ...
    return Scaffold(
                  appBar: new AppBar(backgroundColor: Colors.indigoAccent,title: new Text('Perfil do aluno')),
                  body: Container(color: Colors.indigoAccent[50],child:Center(child: Text("Ainda não há dados para este aluno...",style: TextStyle(
            color: Colors.black,
            fontWeight: FontWeight.w900,
            fontFamily: 'Amatic SC',
            letterSpacing: 2,
      ...
      content: Padding(
          ...
          child: Container(
            ...
            child:  ListView(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(top:15.0,right:30,bottom:20),
                  child: Row(children: [
                    Text(
                      "Aluno",
                      style: TextStyle(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        (DateTime.parse(aluno.dataNascimentoAluno.toDate().toString())).toString(),
                        style: TextStyle(
                            color: Colors.black, letterSpacing: 2, fontSize: 20),
                      ),
                    ],
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            ...
                            Padding(
                  padding: const EdgeInsets.only(top:30.0,right:30,bottom:20),
                  child: Row(children: [
